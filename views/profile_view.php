                ...
                <?php foreach ($this->posts as $post) { ?>
                    <div class="col-md-6 col-lg-3 my-2">
                        <div class="card text-center">
                            <img src="<?= $post['img'] ?>" style="opacity: <?php if (!$post['is_visible']) echo '0.5' ?>;" class="card-img-top img-fluid">
                            <div class="card-block">
                                ...
                                <form action="?page=profile" method="POST">
                                    ...
                                    <div class="edit_card_id_<?= $post['id'] ?>" style="display:none">
                                        ...
                                        <button class="btn btn-danger cancel_btn col-5 m-1" id="<?= $post['id'] ?>">Cancel</button>
                                    </div>
